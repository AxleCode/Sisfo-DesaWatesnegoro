...
<head>
    ...
    <!-- Custom CSS - Same as berita-edit.blade.php -->
    <style>
        :root {
    ...
    <div id="content">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-12">
                        <h2 class="mb-4">Edit Instagram Reel</h2>
                ...
                <form action="{{ route('admin.instagram.update', $reel) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="setting-card">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="order" name="order" 
                                           value="{{ old('order', $reel->order) }}" min="0" required>
                                    <div class="form-text">Urutan tampil (0 = pertama)</div>
                                </div>
        
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                           value="1" {{ old('is_active', $reel->is_active) ? 'checked' : '' }}>
