    ...
    <div id="content">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-12">
                        <h2 class="mb-0">Link Spreadsheet BUMDES</h2>
                        <p class="text-muted mb-0">Atur link untuk embed spreadsheet di halaman publik <code>/bumdes</code>.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="setting-card">
                            <form action="{{ route('admin.bumdes.link.simpan') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Boleh URL <code>/edit</code>, nanti halaman publik otomatis pakai <code>/preview</code>.</div>
                                </div>
