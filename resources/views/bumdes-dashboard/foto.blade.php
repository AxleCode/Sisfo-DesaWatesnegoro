...
<head>
    ...
    <title>Dashboard BUMDES - Foto Slider</title>
    ...
    <style>
        ...
        .slider-image { width: 110px; height: 70px; object-fit: cover; border-radius: 8px; border: 1px solid rgba(0,0,0,.08); }
            ...
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-0">Foto-foto ini tampil di slider halaman publik <code>/bumdes</code>.</p>
                    </div>
                </div>
                                ...
                                @foreach($slides as $slide)
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <form action="{{ route('bumdes.foto.hapus', $slide->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <div class="modal fade" id="editFotoModal{{ $slide->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('bumdes.foto.update', $slide->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('POST')
    ...
    <div class="modal fade" id="tambahFotoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('bumdes.foto.tambah') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Judul</label>
